...
##    yes = numpy.nonzero(Xxs0 > 0 and Xxs0 <= x0 and Xxs1 > 0 and Xxs <= y0)
##
##    premorph0a = numpy.zeros(numpy.shape(image0))
##    premorph0a[yes] = image0[Xxs0[yes] + (Xxs1[yes]-1)*x0]
...
#################################
    ...
    DSUM = numpy.zeros((image0.shape[0], image.shape[1], 2), numpy.float)
...
if __name__ == "__main__":
    ...
    FeatureMorph(image0, image1, 0.5, 10)
